...
var Simulator = function (workflow) {
    ...
    this.initialise = function () {
        ...
        // intecept and stub the shutdown step
        var shutdownStep = workflow.getStepNamed("Shutdown");
        sinon.stub(shutdownStep, "Start", function () {
            console.log("intercepted and prevented system shutdown");
        });
    };
